...
Public Class frmCapnhatsanpham
    ...
    Private Sub btnLoad_Click(sender As Object, e As EventArgs) Handles btnLoad.Click
        ...
        connect.Open()
        Dim xem As SqlDataAdapter = New SqlDataAdapter("select loaiSANPHAM.MASP as 'Mã sản phẩm',loaiSANPHAM.TENSP as 'Tên sản phẩm', LOAISANPHAM.MALOAI as 'Mã Loại', LOAISANPHAM.TENLOAI as 'Tên Loại',SANPHAM.SOLUONG as 'Số lượng' from loaiSANPHAM " & txtMASP.Text & "'", connect)
        Try
    ...
    Private Sub LoadData()
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim load As SqlDataAdapter = New SqlDataAdapter("select loaiSANPHAM.MASP as 'Mã sản phẩm',loaiSANPHAM.TENSP as 'Tên sản phẩm', LOAISANPHAM.MALOAI as 'Mã Loại', LOAISANPHAM.TENLOAI as 'Tên Loại',loaiSANPHAM.SOLUONG as 'Số lượng' from loaiSANPHAM ", conn)
    ...
    Private Sub btnCapnhat_Click(sender As Object, e As EventArgs) Handles btnCapnhat.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim updatequery As String = "update loaiSANPHAM set MASP=@MASP, TENSP=@TENSP, SOLUONG=@SOLUONG where MASP=@MASP update LOAISANPHAM set MALOAI=@MALOAI, MASP=@MASP, TENLOAI=@TENLOAI where MASP=@MASP"
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        Dim delquery As String = "delete from loaiSANPHAM where MASP=@MASP delete from LOAISANPHAM where MASP=@MASP"
    ...
    Private Sub btnThem_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        Dim conn As SqlConnection = New SqlConnection(chuoiketnoi)
        Dim query As String = "insert into loaiSANPHAM values(@MASP,@TENSP,@SOLUONG) "
        ...
        Dim refesh As SqlDataAdapter = New SqlDataAdapter("select loaiSANPHAM.MASP as 'Mã sản phẩm',loaiSANPHAM.TENSP as 'Tên sản phẩm', LOAISANPHAM.MAlsp as 'Mã Loại', LOAISANPHAM.TENLOAI as 'Tên Loại',loaiSANPHAM.SOLUONG as 'Số lượng' from loaiSANPHAM ", conn)
        db.Clear()
        refesh.Fill(db)
        dgvSanpham.DataSource = db.DefaultView
    End Sub
